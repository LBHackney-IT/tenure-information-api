...
namespace TenureInformationApi.Tests.V1.Infrastructure
{
    public class UseErrorCodeInterceptorTests
    {
        ...
        private readonly UseErrorCodeInterceptor _classUnderTest;
        ...
        public UseErrorCodeInterceptorTests()
        {
            ...
            _classUnderTest = new UseErrorCodeInterceptor();
        ...
        {
            _classUnderTest.BeforeAspNetValidation(_actionContext, _mockValidationContext.Object)
        ...
        public void AfterAspNetValidationTestNoErrorsReturnsResult()
        {
            ...
            _classUnderTest.AfterAspNetValidation(_actionContext, _mockValidationContext.Object, validationResult)
        ...
        public void AfterAspNetValidationTestReturnsProjectedResult()
        {
            ...
            var projected = _classUnderTest.AfterAspNetValidation(_actionContext, _mockValidationContext.Object, validationResult);
